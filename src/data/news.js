export const newsArticles = [
  {
    ...
    excerpt:
      "An exclusive interview discussing the interpretation of Mahler's 5th Symphony and the emotional toll of conducting epic works.",
    image:
  ...
  },
  {
    ...
    excerpt:
      'How the new Aetheric Resonance hall utilizes variable acoustic geometry to adapt to different symphonic requirements.',
    image:
  ...
  },
  {
    ...
    excerpt:
      "A remarkable discovery in the philharmonic's basement reveals previously unknown sketches by a 19th-century composer.",
    image:
