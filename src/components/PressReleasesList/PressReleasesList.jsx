...
import styles from './PressReleasesList.module.css';
...
export default function PressReleasesList({ meta, documents = [] }) {
          ...
          <div className={styles.toolbar}>
            <div className={styles.searchWrap}>
              ...
              <input
                ...
                placeholder="Press-reliz nomi, raqami yoki turini qidirish..."
                className={styles.searchInput}
                aria-label="Press-relizlarni qidirish"
              />
              {query && (
                <button
                  type="button"
            ...
            <span className={styles.count}>
              {filtered.length} / {documents.length} press-reliz
            </span>
          </div>

          {filtered.length === 0 ? (
            <p className={styles.empty}>
              Qidiruv bo&apos;yicha press-reliz topilmadi.
            </p>
          ) : (
